...
const WIN_DOC_SLOTS = [
  {
    ...
    desc: "Post-Qualification Notice, Verification & Evaluation Clearances",
  },
  {
    key: "noa",
    title: "Notice of Award (NOA)",
    desc: "Official Notice of Award issued by the Head of Procuring Entity",
  },
  {
    key: "performance_bond",
    title: "Performance Security: PSD / Performance Bond",
    desc: "Performance Securing Declaration (PSD) OR Callable Surety Bond / Bank Guarantee",
  },
  {
    key: "contract",
    title: "Contract Agreement",
    desc: "Signed and Notarized Government Contract Agreement",
  },
  {
    key: "ntp",
    title: "Notice to Proceed (NTP)",
    desc: "Official Notice to Proceed with issuance date and contract effectivity",
  },
  {
    key: "delivery_receipt",
    title: "Delivery Receipt (DR)",
    desc: "Official Delivery Receipt (DR) signed and stamped by Procuring Entity receiving personnel",
  },
  {
    key: "delivery_proof",
    title: "Delivery Proof / Turn-over Proof",
    desc: "Photos of Delivered Goods, On-Site Turn-over Proof, or Inspection & Acceptance Report (IAR)",
  },
  {
    key: "dole_cert",
    title: "DOLE Certification (if applicable)",
    desc: "DOLE BOSH / Approved Construction Safety and Health Program (CSHP)",
  },
];
...
const FINAL_PAYMENT_DOC_SLOTS = [
  {
    ...
    desc: "Official Government Disbursement Voucher (DV) / Entity Payment Processing Voucher",
  },
  {
    key: "cert_completion_acceptance",
    title: "Certificate of Completion / Letter of Acceptance",
    desc: "Official Certificate of Project Completion and Letter of Final Acceptance from Procuring Entity",
  },
  {
    key: "pic_cheque",
    title: "Picture of Cheque",
    desc: "Photo / Scanned Copy of Government Issued Check, LDDAP-ADA, or Warrant of Payment",
  },
  {
    key: "pic_sales_invoice",
    title: "Picture of Sales Invoice / Service Invoice",
    desc: "Official Sales Invoice (SI), Billing Statement, or Service Invoice registered with BIR",
  },
  {
    key: "final_payment_cert",
    title: "Final Billing & Inspection Acceptance (IAR)",
    desc: "Final Statement of Account, Inspection & Acceptance Report, or Final Payment Clearance",
  },
  {
    key: "brgy_cert",
    title: "Certificate from Barangay (BRGY)",
    desc: "Barangay Clearance & Project Completion Certificate from Local LGU",
  },
  {
    key: "bir_tax_clearance",
    title: "Tax Clearance from BIR",
    desc: "Final BIR Tax Clearance & Certificate of Final Tax Withheld (BIR Form 2306/2307)",
  },
  {
    key: "s_curve",
...
export const STATUTORY_DOCUMENT_SLOTS: StatutoryTemplateSlot[] = [
  {
    ...
    templateType: "POW",
    description:
      "Itemized detailed cost estimate, direct/indirect markups, and integrated Terms of Reference PDF attachment.",
  },
  {
    key: "rla",
    ...
    templateType: "RLA",
    description:
      "Formal request letter for 15% mobilization fund with project details and bank guarantee references.",
  },
  {
    key: "swa",
    ...
    templateType: "SWA",
    description:
      "Detailed billing breakdown of work items, percent accomplishment, recoupment and retention.",
  },
  {
    key: "progress_photo",
    ...
    isUploadOnly: true,
    description:
      "Upload PDF / site photo albums showing Before, During, and After milestones.",
  },
  {
    key: "mts",
    ...
    templateType: "MTS",
    description:
      "Quality control and laboratory materials testing log (ASTM/DPWH standards).",
  },
  {
    key: "ca",
    ...
    templateType: "CA",
    description:
      "Sworn notarial affidavit certifying full payment of labor, materials, suppliers and taxes.",
  },
  {
    key: "abp",
    ...
    templateType: "ABP",
    description:
      "As-Built plan drawings index checklist and complete blueprint PDF attachment.",
  },
  {
    key: "ws",
    ...
    isUploadOnly: true,
    description:
      "Upload official Warranty Bond / Bank Guarantee under Section 62 of RA 9184.",
  },
  {
    key: "bs",
    ...
    templateType: "BS",
    description:
      "Statement of account, statutory tax deductions, and bank remittance instructions.",
  },
  {
    key: "cms",
    ...
    templateType: "CMS",
    description:
      "Comprehensive engineering methodology and sequence of execution.",
  },
  {
    key: "eup",
    ...
    templateType: "EUP",
    description:
      "Heavy equipment schedule, plate numbers, and monthly deployment timeline.",
  },
  {
    key: "fpl",
    ...
    templateType: "FPL",
    description:
      "Formal request letter for 100% completion billing and release of retention money.",
  },
  {
    key: "mpds",
    ...
    templateType: "MPDS",
    description:
      "Key personnel and labor workforce headcount distribution per month.",
  },
  {
    key: "pert",
    ...
    templateType: "PERT",
    description:
      "Activity schedule, early/late dates, float, critical path and milestone weights.",
  },
  {
    key: "sote",
    ...
    templateType: "SOTE",
    description:
      "Contract duration tracking, NTP date, approved extensions, and slippage percentage.",
  },
  {
    key: "toa",
...
export const getProjectBidFormAmount = (
  ...
  for (const key of candidateKeys) {
    try {
      ...
      if (raw) {
        ...
        if (
          typeof parsed.totalBidAmount === "number" &&
          parsed.totalBidAmount > 0
        ) {
          num = parsed.totalBidAmount;
          fig = num.toLocaleString("en-US", {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2,
          });
          words = parsed.totalBidAmountWords || numberToWords(num);
        } else if (
          parsed.totalBidAmountFigures &&
          parsed.totalBidAmountFigures !== "0.00"
        ) {
          num =
            parseFloat(
              `${parsed.totalBidAmountFigures}`.replace(/[^0-9.]/g, ""),
            ) || 0;
          fig = parsed.totalBidAmountFigures;
          words = parsed.totalBidAmountWords || numberToWords(num);
        } else if (
          typeof parsed.totalEstimatedProjectCost === "number" &&
          parsed.totalEstimatedProjectCost > 0
        ) {
          ...
          typeof parsed.totalPriceOffered === "number" &&
          parsed.totalPriceOffered > 0
        ) {
          ...
          num = parsed.materials.reduce(
            (acc: number, m: any) =>
              acc + (Number(m.quantity) || 0) * (Number(m.unitPrice) || 0),
            0,
          );
          if (num > 0) {
            fig = num.toLocaleString("en-US", {
  ...
  if (fallbackAbc > 0) {
    return {
      amount: fallbackAbc,
      amountFigures: fallbackAbc.toLocaleString("en-US", {
        minimumFractionDigits: 2,
        maximumFractionDigits: 2,
      }),
...
export const ProjectProfileView: React.FC<ProjectProfileViewProps> = ({
  setActiveTab,
}) => {
  ...
  const [activeWorkspaceRef, setActiveWorkspaceRef] = useState<string>(() => {
    try {
      const saved =
        localStorage.getItem(`bidocs_active_vault_project_${tenantId}`) ||
        localStorage.getItem("bidocs_active_vault_project") ||
        "";
      return saved;
    } catch {
      return "";
  ...
  const selectedProject = useMemo(() => {
    return (
      mergedProjects.find((p) => p.id === selectedProjectId) ||
      (mergedProjects.length > 0 ? mergedProjects[0] : null)
    );
  }, [mergedProjects, selectedProjectId]);

  const projectScopeKey = selectedProject
    ? selectedProject.projectReferenceNumber || selectedProject.philgepsRefNo
    : "default";

  // ---------------------------------------------------------------------------
  // Win Project Status & Winning Bid Form Amount State (3 Options: WIN, LOSE, DQ)
  // ---------------------------------------------------------------------------
  const [projectWinStatus, setProjectWinStatus] = useState<
    "UNSPECIFIED" | "WIN" | "LOSE" | "DQ"
  >("UNSPECIFIED");
  ...
  const [finalPaymentDocs, setFinalPaymentDocs] = useState<
    Record<string, ProjectDocAttachment>
  >({});
  ...
  const [selectedStatutoryGuideCode, setSelectedStatutoryGuideCode] =
    useState<string>("RLA");
  ...
  const [editingExpense, setEditingExpense] =
    useState<ProjectExpenseItem | null>(null);
  ...
  useEffect(() => {
    ...
    const savedStatus = localStorage.getItem(
      `bidocs_project_win_status_${tenantId}_${projectScopeKey}`,
    ) as any;
    const isAwarded =
    ...
    if (isAwarded) {
      ...
      const bidData = getProjectBidFormAmount(
        tenantId,
        projectScopeKey,
        selectedProject.id,
  ...
  const [previewVaultDoc, setPreviewVaultDoc] =
    useState<DocumentVaultItem | null>(null);
  const [showMergedPackageViewerModal, setShowMergedPackageViewerModal] =
    useState(false);
  const [mergedModalFolderCopy, setMergedModalFolderCopy] =
    useState<FolderCopyType>("ORIGINAL");
  const [bidDocCategoryFilter, setBidDocCategoryFilter] = useState<
    "ALL" | "LEGAL" | "TECHNICAL" | "FINANCIAL"
  >("ALL");
  const [bidDocSearchQuery, setBidDocSearchQuery] = useState("");
  const [isGeneratingDocPdf, setIsGeneratingDocPdf] = useState<string | null>(
    null,
  );
  ...
  useEffect(() => {
    if (!tenantId) return;
    loadVaultItems(tenantId)
      .then(async (docs) => {
        const combinedDocs: DocumentVaultItem[] = Array.isArray(docs)
          ? [...docs]
          : [];
        try {
          const rawCompleted = localStorage.getItem(
              ...
              parsed.forEach((form: any) => {
                if (!combinedDocs.some((d) => d.id === form.id)) {
                  combinedDocs.push({
                    ...
                    uploadedByName:
                      currentTenant?.authorizedSignatory?.name ||
      ...
      .catch((e) =>
        console.error("[ProjectStatus] Failed to load vault items:", e),
      );
  ...
  const isInfraProject = useMemo(() => {
    ...
    const combined =
      `${selectedProject?.projectReferenceNumber || ""} ${selectedProject?.title || ""}`.toUpperCase();
    return (
  ...
  const isConsultingProject = useMemo(() => {
    ...
    return (
      ...
      titleLower.includes("master plan")
    );
  }, [selectedProject]);
  ...
  const statutoryDocsList: StatutoryDocDefinition[] = useMemo(() => {
    const list: StatutoryDocDefinition[] = [
      // 1. PhilGEPS Platinum Certificate of Registration
      {
        ...
        name: "PhilGEPS Platinum Certificate of Registration (Annex A)",
        category: "LEGAL",
        envelope: "ENVELOPE_1",
        code: "PHILGEPS_PLATINUM",
        vaultMatchCategory: "ELIGIBILITY_CLASS_A",
        description:
          "Mandatory Class A Platinum 2026 Certificate & Annex A Eligibility Documents",
      },
      // 2. Statement of All Ongoing Government & Private Contracts
      {
        id: "ONGOING_CONTRACTS",
        name: "Statement of All Ongoing Government & Private Contracts",
        category: "TECHNICAL",
        envelope: "ENVELOPE_1",
        code: "ONGOING_CONTRACTS",
        storageKey: `bidocs_ongoing_${tenantId}_${projectScopeKey}`,
        description:
          "Statement of ongoing government & private contracts including awarded but not yet started",
      },
      // 3. Statement of Single Largest Completed Contract (SLCC)
      {
        ...
        envelope: "ENVELOPE_1",
        code: "SLCC_STATEMENT",
        storageKey: `bidocs_slcc_${tenantId}_${projectScopeKey}`,
        description:
          "Similar completed contract within prescribed period complying with 50% ABC threshold",
      },
      // 4. Bid Securing Declaration / Bid Security
      {
        id: "BID_SECURING_DECLARATION",
        name: "Bid Securing Declaration / Bid Security or Surety Bond (BSD)",
        category: "TECHNICAL",
        envelope: "ENVELOPE_1",
        code: "BID_SECURING_DECLARATION",
        storageKey: `bidocs_bsd_${tenantId}_${projectScopeKey}`,
        description:
          "GPPB un-notarized/notarized Bid Securing Declaration or Bank Guarantee/Surety",
      },
      // 5. Section VI: Schedule of Requirements
      {
        ...
        storageKey: `bidocs_sec_vi_${tenantId}_${projectScopeKey}`,
        description:
          "Schedule of delivery commitments, milestones, and site destinations",
      },
      // 6. Section VII: Technical Specifications Statement of Compliance
      {
        id: "TECH_SPECS_SECTION_VII",
        name: "Section VII: Technical Specifications Statement of Compliance",
        category: "TECHNICAL",
        envelope: "ENVELOPE_1",
        code: "TECH_SPECS_SECTION_VII",
        storageKey: `bidocs_tech_specs_${tenantId}_${projectScopeKey}`,
        description:
          "Item-by-item Statement of Compliance with BAC tender parameters",
      },
      // 7. Framework Agreement List
      {
        id: "FRAMEWORK_AGREEMENT_LIST",
        name: "Framework Agreement List",
        category: "TECHNICAL",
        envelope: "ENVELOPE_1",
        code: "FRAMEWORK_AGREEMENT_LIST",
        storageKey: `bidocs_fal_${tenantId}_${projectScopeKey}`,
        description:
          "Itemized Framework Agreement call-off schedules and parameters",
      },
      // 8. Organizational Chart, Manpower Requirements & Key Personnel
      {
        ...
        storageKey: `bidocs_org_chart_${tenantId}_${projectScopeKey}`,
        description:
          "Project management deployment hierarchy and command structure",
      },
      {
        id: "KEY_PERSONNEL",
        name: "Key Personnel Matrix, Bio-Data & PRC Certifications",
        category: "TECHNICAL",
        envelope: "ENVELOPE_1",
        code: "KEY_PERSONNEL",
        storageKey: `bidocs_key_personnel_${tenantId}_${projectScopeKey}`,
        description:
          "Professional qualifications, PRC licenses, and experience bio-data of key technical team",
      },
      {
        id: "MAJOR_EQUIPMENT",
        name: "Contractor's Major Equipment Utilization Matrix",
        category: "TECHNICAL",
        envelope: "ENVELOPE_1",
        code: "MAJOR_EQUIPMENT",
        storageKey: `bidocs_equipment_${tenantId}_${projectScopeKey}`,
        description:
          "Owned, leased, or purchase-agreement heavy machinery and equipment roster",
      },
      // 9. After-Sales Services & Warranty Undertaking
      {
        id: "AFTERSALES_WARRANTY",
        name: "After-Sales Services & Warranty Undertaking",
        category: "TECHNICAL",
        envelope: "ENVELOPE_1",
        code: "AFTERSALES_WARRANTY",
        storageKey: `bidocs_aftersale_${tenantId}_${projectScopeKey}`,
        description:
          "Commitment for spare parts availability, technical response, and maintenance support",
      },
      // 10. Omnibus Sworn Statement (OSS)
      {
        id: "OMNIBUS_SWORN_STATEMENT",
        name: "Omnibus Sworn Statement (OSS)",
        category: "TECHNICAL",
        envelope: "ENVELOPE_1",
        code: "OMNIBUS_SWORN_STATEMENT",
        storageKey: `bidocs_oss_${tenantId}_${projectScopeKey}`,
        description:
          "10-point GPPB statutory notarized affidavit on bidder integrity and non-blacklisting",
      },
      // 11. Net Financial Contracting Capacity (NFCC) Computation
      {
        id: "NFCC_COMPUTATION",
        name: "Net Financial Contracting Capacity (NFCC) Computation",
        category: "TECHNICAL",
        envelope: "ENVELOPE_1",
        code: "NFCC_COMPUTATION",
        storageKey: `bidocs_nfcc_${tenantId}_${projectScopeKey}`,
        description:
          "Statutory NFCC formula computation based on current assets, liabilities, and ongoing contracts",
      },
      // 12. Audited Financial Statements (AFS)
      {
        id: "AUDITED_FS",
        name: "Audited Financial Statements (AFS) stamped received by BIR",
        category: "LEGAL",
        envelope: "ENVELOPE_1",
        code: "AUDITED_FS",
        vaultMatchCategory: "ELIGIBILITY_CLASS_A",
        description:
          "BIR-received balance sheet, income statement, and independent auditor report",
      },
      // 13. Mayor's / Business Permit (Current Year)
      {
        id: "MAYORS_PERMIT",
        name: "Mayor's / Business Permit (Current Year)",
        category: "LEGAL",
        envelope: "ENVELOPE_1",
        code: "MAYORS_PERMIT",
        vaultMatchCategory: "ELIGIBILITY_CLASS_A",
        description:
          "Valid mayor or business permit issued by LGU of principal place of business",
      },
      // 14. PCAB License and Special License
      {
        id: "PCAB_LICENSE",
        name: "PCAB License and Special License (for Infrastructure)",
        category: "LEGAL",
        envelope: "ENVELOPE_1",
        code: "PCAB_LICENSE",
        vaultMatchCategory: "ELIGIBILITY_CLASS_A",
        description:
          "Valid Philippine Contractors Accreditation Board category & classification license",
      },
      // 15. SEC / DTI Certificate of Business Registration
      {
        id: "SEC_DTI_REG",
        name: "SEC / DTI Certificate of Business Registration",
        category: "LEGAL",
        envelope: "ENVELOPE_1",
        code: "SEC_DTI_REG",
        vaultMatchCategory: "ELIGIBILITY_CLASS_A",
        description:
          "SEC Articles of Incorporation / DTI Business Name Certificate / CDA Registration",
      },
      // 16. BIR Certificate of Registration (BIR Form 2303)
      {
        id: "BIR_REGISTRATION",
        name: "BIR Certificate of Registration (BIR Form 2303)",
        category: "LEGAL",
        envelope: "ENVELOPE_1",
        code: "BIR_REGISTRATION",
        vaultMatchCategory: "ELIGIBILITY_CLASS_A",
        description: "Tax identification certificate with registered tax types",
      },
      // 17. BIR Tax Clearance Certificate for Bidding
      {
        id: "TAX_CLEARANCE",
        name: "BIR Tax Clearance Certificate for Bidding (EO 398)",
        category: "LEGAL",
        envelope: "ENVELOPE_1",
        code: "TAX_CLEARANCE",
        vaultMatchCategory: "ELIGIBILITY_CLASS_A",
        description:
          "Executive Order 398 tax clearance for government bidding purposes",
      },
      // 18. Secretary's Certificate / Board Resolution / SPA
      {
        id: "SECRETARY_CERTIFICATE",
        name: "Secretary's Certificate / Board Resolution / Special Power of Attorney (SPA)",
        category: "LEGAL",
        envelope: "ENVELOPE_1",
        code: "SECRETARY_CERTIFICATE",
        vaultMatchCategory: "ELIGIBILITY_CLASS_A",
        description:
          "Corporate authorization granting signatory full authority to execute bid documents",
      },
      // 19. Joint Venture Agreement (JVA)
      {
        id: "JOINT_VENTURE_AGREEMENT",
        name: "Joint Venture Agreement (JVA) / Class B Legal Documents",
        category: "LEGAL",
        envelope: "ENVELOPE_1",
        code: "JOINT_VENTURE_AGREEMENT",
        vaultMatchCategory: "ELIGIBILITY_CLASS_B",
        description:
          "Valid JVA or notarized statements from joint venture partners (if applicable)",
      },
    ];
    ...
    if (isInfraProject) {
      list.push({
        id: "FINANCIAL_BID_FORM_INFRA",
        name: "Financial Bid Form (Infrastructure)",
        category: "FINANCIAL",
        envelope: "ENVELOPE_2",
        code: "GPPB-BIDFORM-INFRASTRUCTURE",
        storageKey: `bidocs_bidform_infra_${tenantId}_${projectScopeKey}`,
        description:
          "Official statutory GPPB Financial Bid Form with lump-sum offer and breakdown",
      });
    } else if (isConsultingProject) {
      list.push({
        id: "FINANCIAL_BID_FORM_CONSULTING",
        name: "Financial Bid Form (Consulting)",
        category: "FINANCIAL",
        envelope: "ENVELOPE_2",
        code: "GPPB-BIDFORM-CONSULTING",
        storageKey: `bidocs_bidform_consulting_${tenantId}_${projectScopeKey}`,
        description:
          "Statutory Financial Proposal Submission Form and remuneration schedules",
      });
    } else {
      list.push({
        id: "FINANCIAL_BID_FORM_GOODS",
        name: "Financial Bid Form (Goods)",
        category: "FINANCIAL",
        envelope: "ENVELOPE_2",
        code: "GPPB-BIDFORM-GOODS",
        storageKey: `bidocs_bidform_goods_${tenantId}_${projectScopeKey}`,
        description:
          "Official statutory GPPB Financial Bid Form for supply & delivery of goods",
      });
    }

    list.push({
      id: "BILL_OF_QUANTITIES",
      name: "Bill of Quantities (BOQ Breakdown)",
      category: "FINANCIAL",
      envelope: "ENVELOPE_2",
      code: "BILL_OF_QUANTITIES",
      storageKey: `bidocs_boq_${tenantId}_${projectScopeKey}`,
      description:
        "Itemized unit price and total cost matrix for every tender pay item",
    });
    list.push({
      id: "DETAILED_ESTIMATES_FORM_L",
      name: "(Form L) Detailed Estimates (Direct Labor, Logistics & Equipment)",
      category: "FINANCIAL",
      envelope: "ENVELOPE_2",
      code: "DETAILED_ESTIMATES_FORM_L",
      storageKey: `bidocs_detailed_estimates_${tenantId}_${projectScopeKey}`,
      description:
        "Unit cost breakdown showing direct materials, direct labor, equipment expenses, OCM, and profit",
    });
    list.push({
      id: "PRICE_SCHEDULE_GOODS",
      name: "Detailed Price Schedule for Goods (Domestic & Foreign)",
      category: "FINANCIAL",
      envelope: "ENVELOPE_2",
      code: "PRICE_SCHEDULE_GOODS",
      storageKey: `bidocs_pricesched_${tenantId}_${projectScopeKey}`,
      description:
        "Price Schedule for goods offered from abroad or within the Philippines",
    });
    list.push({
      id: "SUMMARY_BID_PRICES",
      name: "Summary of Bid Prices & Lump-Sum Breakdown",
      category: "FINANCIAL",
      envelope: "ENVELOPE_2",
      code: "SUMMARY_BID_PRICES",
      storageKey: `bidocs_summary_bid_price_${tenantId}_${projectScopeKey}`,
      description:
        "Consolidated summary of bid prices across project components",
    });
    list.push({
      id: "CASH_FLOW_BY_QUARTER",
      name: "Cash Flow by Quarter and Payment Schedule (SF-INFR-56)",
      category: "FINANCIAL",
      envelope: "ENVELOPE_2",
      code: "CASH_FLOW_BY_QUARTER",
      storageKey: `bidocs_cash_flow_${tenantId}_${projectScopeKey}`,
      description:
        "Quarterly financial disbursements and milestone progress billing schedule",
    });
  ...
  const filteredBidDocs = useMemo(() => {
    return statutoryDocsList.filter((doc) => {
      if (
        ...
        doc.category !== bidDocCategoryFilter
      ) {
        return false;
      }
  ...
  const handlePreviewBidDoc = async (doc: StatutoryDocDefinition) => {
    ...
    const mappedCategory: DocCategory =
      doc.category === "LEGAL"
        ? "ELIGIBILITY_CLASS_A"
  ...
  const handleDownloadBidDoc = async (doc: StatutoryDocDefinition) => {
    ...
    if (!dataUrl) {
      try {
        ...
        console.warn(
          "Could not auto-generate PDF for download:",
          doc.name,
          err,
        );
      }
      ...
      if (saved) {
        ...
        if (mergedList.length > 0 && !selectedProjectId) {
          const matched = mergedList.find(
            (p) =>
              p.projectReferenceNumber === activeWorkspaceRef ||
              p.philgepsRefNo === activeWorkspaceRef,
          );
  ...
  useEffect(() => {
    ...
    try {
      const savedWin = localStorage.getItem(
        `bidocs_win_docs_${tenantId}_${projectScopeKey}`,
      );
      if (savedWin) {
    ...
    try {
      const savedFinal = localStorage.getItem(
        `bidocs_final_payment_docs_${tenantId}_${projectScopeKey}`,
      );
      if (savedFinal) {
    ...
    try {
      const savedStatutory = localStorage.getItem(
        `bidocs_statutory_docs_${tenantId}_${projectScopeKey}`,
      );
      if (savedStatutory) {
    ...
    // Load Other Docs
    try {
      const savedOther = localStorage.getItem(
        `bidocs_other_docs_${tenantId}_${projectScopeKey}`,
      );
      if (savedOther) {
    ...
    try {
      const savedExp = localStorage.getItem(
        `bidocs_project_expenses_${tenantId}_${projectScopeKey}`,
      );
      if (savedExp) {
  ...
  const handleUploadSlotDoc = async (
    ...
    if (!isPdf && !isImage) {
      alert(
        "Please upload a valid PDF document or image file (PNG, JPG, JPEG, WEBP).",
      );
      return;
    }
    ...
    reader.onload = async () => {
      ...
      try {
        ...
        console.error(
          "[ProjectProfileView] Error saving document to IndexedDB:",
          err,
        );
      }
  ...
  const handleSavePsdToSlotDoc = async (
    dataUrl?: string,
    customName?: string,
  ) => {
    if (!dataUrl) {
    ...
    const updated: Record<string, ProjectDocAttachment> = {
      ...winDocs,
      [slotKey]: docItem,
    };
    setWinDocs(updated);
  ...
  const handleDeleteSlotDoc = async (
    ...
    if (!confirm(`Are you sure you want to remove this attached document?`))
      return;
  ...
  const handleSaveStatutoryDoc = async (
    ...
    const docItem: ProjectDocAttachment = {
      ...
      fileSizeBytes: fileDataUrl.length
        ? Math.round((fileDataUrl.length * 3) / 4)
        : 1024,
      uploadedAt: new Date().toISOString(),
      fileDataUrl,
    };
  ...
  const handlePreviewStatutoryDoc = async (
    slotKey: string,
    slotTitle: string,
  ) => {
    ...
    if (dataUrl) {
      ...
      alert(
        "Statutory document PDF not found. Please fill or upload the form first.",
      );
    }
  };

  const handleDeleteStatutoryDoc = async (
    slotKey: string,
    slotTitle: string,
  ) => {
  ...
  const [expenseFormCategory, setExpenseFormCategory] = useState(
  ...
  const [expenseFormPaidBy, setExpenseFormPaidBy] = useState(
    currentTenant?.authorizedSignatory?.name || "",
  );
  ...
  const [expenseFormReceiptSize, setExpenseFormReceiptSize] = useState<
    number | undefined
  >(undefined);
  const [expenseFormReceiptDataUrl, setExpenseFormReceiptDataUrl] =
    useState("");
  ...
  const handleOpenEditExpenseModal = async (exp: ProjectExpenseItem) => {
    ...
    if (!dataUrl && exp.receiptFileName) {
      try {
        dataUrl =
          (await loadPdfData(
            `proj_exp_rcpt_${tenantId}_${projectScopeKey}_${exp.id}`,
          )) || "";
      } catch (e) {}
    }
  ...
  const handleDirectUploadReceipt = async (expenseId: string, file: File) => {
    ...
    reader.onload = async () => {
      ...
      setExpenses(updated);
      try {
        const cleanStorage = updated.map((e) => ({
          ...e,
  ...
  const handleViewExpenseReceipt = async (exp: ProjectExpenseItem) => {
    ...
    if (dataUrl) {
      setPreviewPdfModal({
        ...
        fileName:
          exp.receiptFileName || `Receipt-${exp.orNumber || exp.id}.pdf`,
        dataUrl,
      });
    } else {
  ...
  const handleSaveExpense = async () => {
    ...
    const item: ProjectExpenseItem = {
      ...
      receiptUploadedAt: expenseFormReceiptName
        ? editingExpense?.receiptUploadedAt || new Date().toISOString()
        : undefined,
  ...
  const expenseAbcPercentage = useMemo(() => {
    if (
      !selectedProject ||
      !selectedProject.approvedBudget ||
      selectedProject.approvedBudget === 0
    )
      return 0;
  ...
  const [formStatus, setFormStatus] = useState<
    "OPEN" | "CLOSED" | "AWARDED" | "AWARDED_TO_OTHERS" | "CANCELLED"
  >("OPEN");

  const handleOpenNewProjectModal = () => {
    setIsEditing(false);
    const randomRef =
      "PhilGEPS-" + Math.floor(10000000 + Math.random() * 9000000);
  ...
  const handleOpenEditModal = (proj: PhilGEPSOpportunity) => {
    ...
    setFormAbcInput(
      proj.approvedBudget
        ? proj.approvedBudget.toLocaleString("en-US", {
            minimumFractionDigits: 2,
          })
        : "",
    );
    ...
    setFormDeadlineDate(
      proj.submissionDeadlineDatetime || proj.submissionDeadline || "",
    );
  ...
  const handleSaveProjectProfile = () => {
    ...
    const updatedItem: PhilGEPSOpportunity = {
      ...
      submissionDeadline: formDeadlineDate
        ? formDeadlineDate.substring(0, 10)
        : "",
  ...
  const handleDeleteProject = (proj: PhilGEPSOpportunity) => {
    if (
      confirm(
        `Are you sure you want to delete Project Status: "${proj.title}" (${proj.philgepsRefNo})?`,
      )
    ) {
  ...
  const metrics = useMemo(() => {
    ...
    const totalAbc = mergedProjects.reduce(
      (acc, p) => acc + (p.approvedBudget || 0),
      0,
    );
    const goodsCount = mergedProjects.filter((p) =>
      (p.procurementType || "").toUpperCase().includes("GOOD"),
    ).length;
    const infraCount = mergedProjects.filter((p) =>
      (p.procurementType || "").toUpperCase().includes("INFRA"),
    ).length;
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800/80 pb-5">
        <div>
          <div className="flex items-center gap-2.5">
            <div className="p-2 bg-linear-to-br from-blue-600/30 to-indigo-600/20 text-blue-400 rounded-xl border border-blue-500/30 shadow-lg shadow-blue-500/10">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Centralized Bidding Specifications, Win DOCs, Final Payments,
                Expenses Tracker & Merged Bid Docs
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          <button
            ...
            className="px-3.5 py-2 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white rounded-xl text-xs font-bold flex items-center gap-2 transition shadow-lg shadow-blue-600/20 border border-blue-400/30 cursor-pointer"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
        ...
        <SpotlightCard className="p-4 bg-slate-900/60 border border-slate-800/80 rounded-2xl relative overflow-hidden">
          ...
          <p className="text-2xl font-black text-emerald-400 mt-1">
            {formatPhpCurrency(metrics.totalAbc)}
          </p>
          <p className="text-[10px] text-slate-500 font-mono mt-0.5">
              ...
              {filteredProjects.length === 0 ? (
                <div className="p-6 text-center bg-slate-950/60 rounded-xl border border-dashed border-slate-800 space-y-3">
                  ...
                  <p className="text-xs font-bold text-slate-300">
                    No Merged Projects Yet
                  </p>
                  <p className="text-[11px] text-slate-500 leading-tight">
                    Projects only appear in Project Status after their bidding
                    documents package has been merged & completed in Bid Package
                    Builder.
                  </p>
                  <button
                ...
                filteredProjects.map((proj) => {
                  ...
                  const isWorkspaceActive =
                    proj.projectReferenceNumber === activeWorkspaceRef ||
                    proj.philgepsRefNo === activeWorkspaceRef;
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        <span className="text-[10px] font-mono font-bold text-blue-400 bg-blue-950/80 px-2 py-0.5 rounded border border-blue-800/50 truncate max-w-42.5">
                      ...
                      <div className="text-[11px] text-slate-400 mt-2 space-y-0.5 font-sans">
                        ...
                        <div className="flex items-center justify-between pt-1 border-t border-slate-800/60 mt-1.5 text-[11px]">
                          ...
                          <span className="text-[10px] text-slate-500 font-mono">
                            {proj.submissionDeadline
                              ? `Due: ${proj.submissionDeadline.substring(0, 10)}`
                              : "No Deadline"}
                          </span>
                        </div>
                      </div>
            ...
            <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 sm:p-6 space-y-6 shadow-2xl backdrop-blur-md relative overflow-hidden">
                ...
                <div className="space-y-1.5 flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="px-2 py-0.5 bg-amber-950 text-amber-300 text-[11px] font-mono font-bold rounded-lg border border-amber-700/60">
                      {selectedProject.legalRegime === "RA_12009_NGPA"
                        ? "RA 12009 (NGPA)"
                        : "RA 9184 Standard"}
                    </span>
                  </div>
              ...
              <div className="flex items-center gap-1.5 border-b border-slate-800 pb-2 overflow-x-auto text-xs font-semibold">
                {[
                  {
                    id: "general",
                    label: "General & PhilGEPS",
                    icon: Briefcase,
                  },
                  { id: "win_docs", label: "Win DOCs", icon: Award },
                  {
                    id: "final_payment",
                    label: "Final Payment Document",
                    icon: FileCheck2,
                  },
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      ...
                      <div className="p-3 bg-slate-950/70 border border-slate-800/90 rounded-xl space-y-1">
                        <span className="text-[10px] font-mono uppercase text-slate-500 font-bold block">
                          Solicitation / ITB Number
                        </span>
                        <p className="text-sm font-bold font-mono text-white">
                          {selectedProject.solicitationNumber || "N/A"}
                        </p>
                      </div>

                      <div className="p-3 bg-slate-950/70 border border-slate-800/90 rounded-xl space-y-1">
                        <span className="text-[10px] font-mono uppercase text-slate-500 font-bold block">
                          Internal Project Ref Number
                        </span>
                        <p className="text-sm font-bold font-mono text-white">
                          {selectedProject.projectReferenceNumber ||
                            selectedProject.philgepsRefNo}
                      ...
                      <div className="p-3 bg-slate-950/70 border border-slate-800/90 rounded-xl space-y-1">
                        ...
                        <p className="text-xs font-bold text-white">
                          {selectedProject.sector || "Government"} •{" "}
                          {selectedProject.legalRegime === "RA_12009_NGPA"
                            ? "RA 12009 (NGPA)"
                            : "RA 9184"}
                        </p>
                      ...
                      <div className="p-3 bg-slate-950/70 border border-slate-800/90 rounded-xl space-y-1">
                        <span className="text-[10px] font-mono uppercase text-slate-500 font-bold block">
                          Area of Delivery / Site
                        </span>
                        <p className="text-xs font-bold text-white truncate">
                          {selectedProject.areaOfDelivery ||
                            selectedProject.location ||
                            "Philippines"}
                        </p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="p-3 bg-slate-950/70 border border-slate-800/90 rounded-xl space-y-1 sm:col-span-2">
                        ...
                        <p className="text-sm font-bold text-white">
                          {selectedProject.procuringEntity}
                        </p>
                        <p className="text-xs text-slate-400 flex items-center gap-1 pt-0.5">
                          <MapPin className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                          <span>
                            {selectedProject.procuringEntityAddress ||
                              "Official BAC Address"}
                          </span>
                        </p>
                      </div>
                      ...
                      <div className="p-3 bg-slate-950/70 border border-slate-800/90 rounded-xl space-y-1">
                        <span className="text-[10px] font-mono uppercase text-emerald-400 font-bold block">
                          Head of Procuring Entity (HoPE) / Signatory
                        </span>
                        <p className="text-xs font-bold text-white">
                          {selectedProject.headOfProcuringEntity ||
                            selectedProject.procuringEntityContactPerson ||
                            "Head of Procuring Entity"}
                        </p>
                        <p className="text-[11px] text-slate-400">
                          {selectedProject.headOfProcuringEntityPosition ||
                            "District Engineer / Regional Director / Mayor"}
                        </p>
                      </div>

                      <div className="p-3 bg-slate-950/70 border border-slate-800/90 rounded-xl space-y-1">
                        <span className="text-[10px] font-mono uppercase text-cyan-400 font-bold block">
                          PhilGEPS Liaison / BAC Secretariat
                        </span>
                        <p className="text-xs font-bold text-white">
                          {selectedProject.procuringEntityContactPerson ||
                        ...
                        <p className="text-[11px] text-slate-400">
                          {selectedProject.procuringEntityPosition ||
                            "Procurement Liaison / Secretariat"}
                        </p>
                      </div>
                      ...
                      <div className="p-3 bg-slate-950/70 border border-slate-800/90 rounded-xl space-y-1 sm:col-span-2">
                        ...
                        <div className="flex flex-wrap items-center gap-4 pt-0.5">
                          <p className="text-xs font-mono text-slate-300 flex items-center gap-1.5">
                            ...
                            <span>
                              {selectedProject.procuringEntityContactNumber ||
                                "(02) 8000-0000"}
                            </span>
                          </p>
                          <p className="text-xs font-mono text-slate-300 flex items-center gap-1.5">
                            ...
                            <span>
                              {selectedProject.procuringEntityEmail ||
                                "bac@procuringentity.gov.ph"}
                            </span>
                          </p>
                        </div>
                      </div>
                  ...
                  {financialDetails && (
                    <div className="space-y-3 pt-2 border-t border-slate-800/80">
                      ...
                      <div className="p-4 bg-linear-to-br from-emerald-950/60 to-slate-950/90 border border-emerald-500/40 rounded-xl space-y-1.5">
                        ...
                        <p className="text-xs font-serif italic text-slate-300 bg-black/40 p-2 rounded-lg border border-emerald-900/40">
                          Amount in words:{" "}
                          <strong>{financialDetails.words}</strong>
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-xs">
                        <div className="p-2.5 bg-slate-950/70 border border-slate-800 rounded-xl space-y-0.5">
                          ...
                          <p className="font-mono font-bold text-white">
                            {formatPhpCurrency(financialDetails.bidSecCash2Pct)}
                          </p>
                        </div>
                        <div className="p-2.5 bg-slate-950/70 border border-slate-800 rounded-xl space-y-0.5">
                          ...
                          <p className="font-mono font-bold text-white">
                            {formatPhpCurrency(
                              financialDetails.bidSecSurety5Pct,
                            )}
                          </p>
                        </div>
                        <div className="p-2.5 bg-slate-950/70 border border-slate-800 rounded-xl space-y-0.5">
                          ...
                          <p className="font-mono font-bold text-white">
                            {formatPhpCurrency(financialDetails.slcc50Pct)}
                          </p>
                        </div>
                        <div className="p-2.5 bg-slate-950/70 border border-slate-800 rounded-xl space-y-0.5">
                          ...
                          <p className="font-mono font-bold text-white">
                            {formatPhpCurrency(financialDetails.slcc25Pct)}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3 pt-2 border-t border-slate-800/80">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div className="p-3 bg-slate-950/70 border border-slate-800/90 rounded-xl space-y-1">
                        ...
                        <p className="text-xs font-bold text-white">
                          {selectedProject.preBidConferenceDatetime
                            ? selectedProject.preBidConferenceDatetime.replace(
                                "T",
                                " ",
                              )
                            : "As per ITB"}
                      ...
                      <div className="p-3 bg-red-950/30 border border-red-500/40 rounded-xl space-y-1">
                        ...
                        <p className="text-xs font-bold text-red-300">
                          {selectedProject.submissionDeadlineDatetime
                            ? selectedProject.submissionDeadlineDatetime.replace(
                                "T",
                                " ",
                              )
                            : selectedProject.submissionDeadline ||
                              "As per ITB"}
                        </p>
                      </div>
                      ...
                      <div className="p-3 bg-slate-950/70 border border-slate-800/90 rounded-xl space-y-1">
                        ...
                        <p className="text-xs font-bold text-white">
                          {selectedProject.bidOpeningDate
                            ? selectedProject.bidOpeningDate.replace("T", " ")
                    ...
                    <div className="p-3.5 bg-slate-950/70 border border-slate-800/90 rounded-xl flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-slate-400">
                          {currentTenant?.authorizedSignatory?.title ||
                  ...
                  <div className="space-y-3 pt-2 border-t border-slate-800/80">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-mono font-bold text-white uppercase tracking-wider flex items-center gap-1.5">
                        ...
                        <span>
                          6. Official Project Status Summary Sheet (Printable)
                        </span>
                      </span>
                    ...
                    <div className="bg-white text-slate-950 p-6 sm:p-8 rounded-xl shadow-xl border-2 border-slate-900 font-serif space-y-4 text-left text-xs max-w-204 mx-auto print:m-0 print:border-none print:shadow-none">
                      {/* Header */}
                      <div className="flex items-start justify-between border-b-2 border-slate-900 pb-2">
                        <div>
                          ...
                          <p className="text-[10px] font-mono text-slate-600">
                            ...
                            PhilGEPS:{" "}
                            {currentTenant?.philgepsPlatinumNo ||
                              "PLATINUM-2026"}
                          </p>
                        </div>
                      ...
                      <table className="w-full border-collapse border border-slate-900 text-[10px]">
                        <tbody>
                          <tr className="border-b border-slate-900">
                            <td className="w-1/3 p-1 font-bold bg-slate-100 border-r border-slate-900">
                              PROJECT TITLE:
                            </td>
                            <td className="w-2/3 p-1 font-bold text-slate-950">
                              {selectedProject.title}
                            </td>
                          </tr>
                          <tr className="border-b border-slate-900">
                            <td className="p-1 font-bold bg-slate-100 border-r border-slate-900">
                              PHILGEPS REF NO.:
                            </td>
                            <td className="p-1 font-mono font-bold text-blue-900">
                              {selectedProject.philgepsRefNo}
                            </td>
                          </tr>
                          <tr className="border-b border-slate-900">
                      ...
                      <div className="pt-4 flex items-end justify-between">
                        ...
                        <div className="text-center font-serif min-w-50">
              ...
              {activeTabSection === "win_docs" && (
                <div className="space-y-5">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
                    <div>
                      <h3 className="text-sm font-bold text-white flex items-center gap-2">
                        ...
                        <span>
                          Win DOCs — Post-Award & Contract Execution Dossier
                        </span>
                      </h3>
                      <p className="text-xs text-slate-400">
                        Official contract execution repository, winning bid
                        price synchronization, and statutory post-award
                        documentation.
                      </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      {projectWinStatus === "WIN" && (
                        <span className="px-3 py-1 bg-linear-to-r from-amber-500/20 to-emerald-500/20 text-amber-300 border border-amber-500/40 rounded-xl text-xs font-bold font-mono flex items-center gap-1.5 shadow-sm">
                  ...
                  {projectWinStatus === "UNSPECIFIED" && (
                    <div className="p-6 bg-linear-to-br from-blue-950/40 via-slate-900/90 to-indigo-950/40 border border-blue-500/40 rounded-2xl relative overflow-hidden shadow-2xl space-y-5">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <p className="text-xs text-slate-300 leading-relaxed max-w-2xl">
                            Select the official bidding outcome from BAC
                            post-qualification & evaluation. If you{" "}
                            <strong className="text-emerald-300">WON</strong>,
                            BiDOCS will automatically fetch and display your
                            exact offer price from the{" "}
                            <strong className="text-emerald-300">
                              Financial Bid Form
                            </strong>{" "}
                            and calculate statutory Performance Security bonds.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 pt-2 border-t border-slate-800/80">
                        ...
                        >
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-[11px] text-slate-300 leading-relaxed">
                              Awarded the contract (LCRB / SCRB). Automatically
                              syncs winning amount from Financial Bid Form &
                              computes statutory performance bonds.
                            </p>
                          </div>
                        ...
                        <button
                          ...
                          className="p-4 bg-linear-to-b from-slate-900/90 to-slate-950 hover:from-slate-800/90 hover:to-slate-900 border border-slate-700 hover:border-slate-500 rounded-2xl text-left transition-all duration-200 group relative overflow-hidden shadow-lg cursor-pointer flex flex-col justify-between gap-3"
                        >
                          <div className="flex items-center justify-between w-full">
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-[11px] text-slate-400 leading-relaxed">
                              Contract awarded to another qualified bidder.
                              Retains all compiled and merged bid dossiers in
                              this tab for record-keeping.
                            </p>
                          </div>
                        ...
                        <button
                          ...
                          className="p-4 bg-linear-to-b from-rose-950/30 to-slate-900/90 hover:from-rose-900/50 hover:to-slate-900 border border-rose-500/40 hover:border-rose-400 rounded-2xl text-left transition-all duration-200 group relative overflow-hidden shadow-lg cursor-pointer flex flex-col justify-between gap-3"
                        >
                          <div className="flex items-center justify-between w-full">
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-[11px] text-slate-300 leading-relaxed">
                              Disqualified or declared ineligible during opening
                              or post-qualification. Allows storing BAC findings
                              and Motion for Reconsideration (MR).
                            </p>
                          </div>
                  ...
                  {projectWinStatus === "WIN" && (
                    <div className="p-5 sm:p-6 bg-linear-to-br from-amber-950/30 via-slate-900/95 to-emerald-950/30 border border-amber-500/50 rounded-2xl relative overflow-hidden shadow-2xl space-y-4">
                        ...
                        <div className="md:col-span-7 p-4 bg-slate-950/80 rounded-xl border border-emerald-500/30 space-y-2">
                          <div className="flex items-center justify-between">
                            <span className="text-[10px] font-mono uppercase font-bold text-emerald-400">
                              Winning Bid Contract Price (As Evaluated &
                              Awarded)
                            </span>
                          ...
                          <div className="p-2.5 bg-black/40 rounded-lg border border-slate-800/80">
                            <p className="text-[11px] font-serif italic text-slate-300 leading-snug">
                              <span className="text-slate-500 font-sans not-italic text-[10px] font-bold uppercase mr-1">
                                In Words:
                              </span>
                      ...
                      <div className="p-3.5 bg-slate-950/60 rounded-xl border border-slate-800/80 space-y-2">
                        <div className="flex items-center justify-between">
                          <span className="text-[11px] font-mono font-bold uppercase text-amber-400 flex items-center gap-1.5">
                            ...
                            <span>
                              Statutory Performance Security Requirements
                              (Computed from Winning Bid)
                            </span>
                          </span>
                          <span className="text-[9px] font-mono text-slate-500">
                            Sec. 39 RA 9184 / RA 12009
                          </span>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-xs font-mono">
                          <div className="p-2.5 bg-slate-900/90 border border-slate-800 rounded-lg space-y-0.5">
                            <span className="text-[9px] text-blue-400 font-bold block uppercase">
                              5% Cash / Manager's Check
                            </span>
                            <p className="font-bold text-white">
                              {formatPhpCurrency(winningBidData.amount * 0.05)}
                            </p>
                          </div>

                          <div className="p-2.5 bg-slate-900/90 border border-slate-800 rounded-lg space-y-0.5">
                            <span className="text-[9px] text-cyan-400 font-bold block uppercase">
                              10% Bank Guarantee / LC
                            </span>
                            <p className="font-bold text-white">
                              {formatPhpCurrency(winningBidData.amount * 0.1)}
                            </p>
                          </div>
                          ...
                          <div className="p-2.5 bg-slate-900/90 border border-amber-500/30 rounded-lg space-y-0.5">
                            <span className="text-[9px] text-amber-400 font-bold block uppercase">
                              30% Callable Surety Bond
                            </span>
                            <p className="font-bold text-amber-300">
                              {formatPhpCurrency(winningBidData.amount * 0.3)}
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <h4 className="text-xs font-bold text-slate-200">
                              Status: Awarded to Other Bidder (LOSE)
                            </h4>
                          ...
                          <p className="text-[11px] text-slate-400 mt-0.5">
                            This bidding project was awarded to another
                            qualified bidder. All compiled and merged bid
                            packages remain archived and accessible.
                          </p>
                        </div>
                      </div>
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <h4 className="text-xs font-bold text-rose-200">
                              Status: Disqualified / Ineligible / Non-Responsive
                              (DQ)
                            </h4>
                          ...
                          <p className="text-[11px] text-slate-300 mt-0.5">
                            This project was disqualified or found non-compliant
                            during opening or BAC post-qualification evaluation.
                            You can track BAC evaluation findings or log Motion
                  ...
                  <div className="space-y-3 pt-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-mono font-bold text-slate-300 uppercase tracking-wider flex items-center gap-1.5">
                        ...
                        <span>
                          Statutory Post-Award Document Attachments (
                          {WIN_DOC_SLOTS.length} Slots)
                        </span>
                      </span>
                      <span className="text-[10px] font-mono text-slate-400">
                        {Object.keys(winDocs).length} / {WIN_DOC_SLOTS.length}{" "}
                        Documents Attached
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {WIN_DOC_SLOTS.map((slot) => {
                        ...
                        const isImg =
                          attached?.fileName &&
                          /\.(png|jpe?g|webp)$/i.test(attached.fileName);
                              ...
                              <div>
                                ...
                                <h4 className="text-xs font-bold text-white flex items-center gap-1.5 mt-0.5">
                                  {isImg ? (
                                    ...
                                    <FileText
                                      className={`w-3.5 h-3.5 ${hasFile ? "text-emerald-400" : "text-slate-400"}`}
                                    />
                                  )}
                              ...
                              <div className="p-2.5 bg-slate-900/90 rounded-xl border border-emerald-500/30 flex items-center justify-between text-xs font-mono">
                                <div className="truncate mr-2">
                                  ...
                                  <p className="text-[10px] text-slate-400">
                                    {attached.fileSizeBytes
                                      ? `${(attached.fileSizeBytes / 1024).toFixed(1)} KB`
                                      : ""}{" "}
                                    •{" "}
                                    {attached.uploadedAt
                                      ? attached.uploadedAt.substring(0, 10)
                                      : ""}
                                  </p>
                                </div>
                                ...
                                <div className="flex items-center gap-1 shrink-0">
                                  ...
                                  <button
                                    type="button"
                                    onClick={() =>
                                      handleDeleteSlotDoc(slot.key, "WIN_DOCS")
                                    }
                            ...
                            {slot.key === "performance_bond" ? (
                              <div className="space-y-2">
                                ...
                                <p className="text-[10px] text-slate-400 font-mono text-center">
                                  Upload signed PSD or Surety Bond / Bank
                                  Guarantee, or fill PSD template
                                </p>
                              </div>
                            ) : (
                              <div>
                  ...
                  <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                    <div>
                      <h3 className="text-sm font-bold text-white flex items-center gap-2">
                        ...
                        <span>
                          Final Payment Document — Contract Completion &
                          Clearance Dossier
                        </span>
                      </h3>
                      <p className="text-xs text-slate-400">
                        Upload required disbursement voucher, certificate of
                        completion / acceptance, cheque photo, sales/service
                        invoice, barangay certification, BIR tax clearance, and
                        final progress S-Curve.
                      </p>
                    </div>
                    <span className="text-[10px] font-mono text-slate-400 shrink-0">
                      {Object.keys(finalPaymentDocs).length} /{" "}
                      {FINAL_PAYMENT_DOC_SLOTS.length} Uploaded
                    </span>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
                    <div>
                      ...
                      <p className="text-xs text-slate-400">
                        Log and calculate all project-related expenditures with
                        attached official receipts, bank deposit slips, and
                        invoices.
                      </p>
                    </div>
                    ...
                    <button
                      ...
                      className="px-3.5 py-1.5 bg-linear-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 transition shadow-lg shadow-cyan-600/20 cursor-pointer"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div className="p-3.5 bg-slate-950/70 border border-slate-800 rounded-xl space-y-1">
                      ...
                      <p className="text-xl font-bold font-mono text-cyan-300">
                        {formatPhpCurrency(totalProjectExpenses)}
                      </p>
                    </div>

                    <div className="p-3.5 bg-slate-950/70 border border-slate-800 rounded-xl space-y-1">
                      <span className="text-[10px] font-mono uppercase text-slate-400 font-bold block">
                        % of Approved Budget (ABC)
                      </span>
                      <p className="text-xl font-bold font-mono text-amber-300">
                        {expenseAbcPercentage.toFixed(2)}%
                      </p>
                    </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {expenses.length > 0 && (
                          <span className="px-2 py-0.5 bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-[10px] font-mono rounded-full font-bold">
                            {Math.round(
                              (expensesWithReceiptsCount / expenses.length) *
                                100,
                            )}
                            % Verified
                          </span>
                          ...
                          {expenses.length === 0 ? (
                            <tr>
                              ...
                              >
                                ...
                                yet. Click "+ Log New Expense" to record
                                expenditures and attach official receipts.
                              </td>
                            </tr>
                          ) : (
                            expenses.map((exp) => (
                              ...
                              >
                                ...
                                <td className="p-3 font-mono font-bold text-emerald-400 text-right whitespace-nowrap">
                                  {formatPhpCurrency(exp.amount)}
                                </td>
                                <td className="p-3">
                                  {exp.receiptFileName ? (
                                    <div className="flex items-center gap-1.5 flex-wrap">
                                      <div
                                        className="flex items-center gap-1 px-2 py-1 bg-emerald-500/10 border border-emerald-500/30 rounded-lg text-emerald-300 text-[11px] font-mono max-w-45 truncate"
                                      ...
                                      >
                                        ...
                                        {exp.receiptFileSizeBytes && (
                                          <span className="text-[9px] text-emerald-400/70 shrink-0">
                                            (
                                            {formatBytes(
                                              exp.receiptFileSizeBytes,
                                            )}
                                      ...
                                      <label
                                        className="p-1 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-md transition cursor-pointer"
                                        title="Replace Attached Receipt"
                                      >
                                ...
                                <td className="p-3 text-center whitespace-nowrap">
                                  <div className="flex items-center justify-center gap-1">
                                    <button
                                      onClick={() =>
                                        handleOpenEditExpenseModal(exp)
                                      }
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
                    <div>
                      <h3 className="text-sm font-bold text-white flex items-center gap-2">
                        ...
                        <span>
                          Bid Docs — Master Bidding Package & Statutory Dossier
                        </span>
                      </h3>
                      <p className="text-xs text-slate-400">
                        Official repository of 3-copy merged packages (Original,
                        Copy 1, Copy 2) and all Legal, Technical, and Financial
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      <button
                        ...
                        className="px-3.5 py-1.5 bg-linear-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 transition shadow-lg shadow-purple-600/20 border border-purple-400/30 cursor-pointer"
                      >
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-mono font-bold text-slate-300 uppercase tracking-wider flex items-center gap-1.5">
                        ...
                        <span>
                          3-Copy Merged Packages (RA 9184 & RA 12009 Standards)
                        </span>
                      </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {/* 1. ORIGINAL COPY */}
                      <div className="p-4 bg-linear-to-b from-blue-950/30 to-slate-900/90 border border-blue-500/40 rounded-2xl space-y-3 relative overflow-hidden shadow-lg flex flex-col justify-between">
                        <div>
                          ...
                          <p className="text-[11px] text-slate-300 mt-1 leading-relaxed">
                            Complete master compilation containing Envelope 1
                            (Legal & Technical) and Envelope 2 (Financial) with
                            un-watermarked master proposal and original
                            notarized documents.
                          </p>
                        </div>
                      ...
                      {/* 2. COPY 1 */}
                      <div className="p-4 bg-linear-to-b from-purple-950/30 to-slate-900/90 border border-purple-500/40 rounded-2xl space-y-3 relative overflow-hidden shadow-lg flex flex-col justify-between">
                        <div>
                          <div className="flex items-center justify-between mb-2">
                          ...
                          <p className="text-[11px] text-slate-300 mt-1 leading-relaxed">
                            Stamped on every page with official "CERTIFIED TRUE
                            COPY — COPY 1", authorized signatory stamp, and date
                            stamp pursuant to statutory procurement
                            requirements.
                          </p>
                        </div>
                      ...
                      {/* 3. COPY 2 */}
                      <div className="p-4 bg-linear-to-b from-emerald-950/30 to-slate-900/90 border border-emerald-500/40 rounded-2xl space-y-3 relative overflow-hidden shadow-lg flex flex-col justify-between">
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-[10px] font-mono uppercase font-bold text-emerald-400">
                          ...
                          <p className="text-[11px] text-slate-300 mt-1 leading-relaxed">
                            Stamped on every page with official "CERTIFIED TRUE
                            COPY — COPY 2" for duplicate BAC evaluation
                            committee members and statutory archives.
                          </p>
                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div>
                        <span className="text-xs font-mono font-bold text-slate-300 uppercase tracking-wider flex items-center gap-1.5">
                          ...
                          <span>
                            All Bidding Documents ({statutoryDocsList.length}{" "}
                            Items)
                          </span>
                        </span>
                        <p className="text-[11px] text-slate-400 mt-0.5">
                          Inspect and preview individual Legal, Technical, and
                          Financial bidding forms and verified attachments.
                        </p>
                      </div>
                        ...
                        <table className="w-full text-left text-xs">
                          <thead className="bg-slate-900/90 text-[10px] font-mono uppercase text-slate-400 border-b border-slate-800">
                            <tr>
                              ...
                              <th className="p-3.5">
                                Document Title & Statutory Reference
                              </th>
                            ...
                            {filteredBidDocs.length === 0 ? (
                              <tr>
                                <td
                                  ...
                                  className="p-8 text-center text-slate-500 text-xs"
                                >
                                  No bidding documents matching "
                                  {bidDocSearchQuery}" in this category.
                                </td>
                              </tr>
                            ) : (
                                  ...
                                  >
                                    ...
                                    <td className="p-3.5">
                                      <span className="text-[10px] font-mono text-slate-300">
                                        {doc.envelope === "ENVELOPE_1"
                                          ? "Envelope 1 (Tech & Legal)"
              ...
              {/* ═════════════════════════════════════════════════════════════ */}
              {(activeTabSection === "statutory_docs" ||
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
                    <div>
                      ...
                      <p className="text-xs text-slate-400">
                        Official Philippine Government (RA 9184 / RA 12009 /
                        DPWH) statutory execution, billing, and close-out
                        documents on Philippine Legal (8.5" x 13").
                      </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-3.5 py-1.5 bg-linear-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 transition shadow-lg shadow-emerald-600/20 cursor-pointer"
                      >
                      ...
                      <span className="px-2.5 py-1 bg-emerald-950/80 text-emerald-300 border border-emerald-700/50 rounded-lg text-xs font-mono font-bold">
                        {Object.keys(statutoryDocs).length} /{" "}
                        {STATUTORY_DOCUMENT_SLOTS.length} COMPLETED
                      </span>
                    </div>
                  </div>
                      ...
                      return (
                        ...
                        >
                          <div>
                            ...
                            {isCompleted && (
                              <p className="text-[10px] text-slate-500 font-mono mt-2">
                                {docMeta.fileName || `${slot.code}.pdf`} •{" "}
                                {docMeta.fileSizeBytes
                                  ? `${(docMeta.fileSizeBytes / 1024).toFixed(1)} KB`
                                  : "Attached"}
                              </p>
                            )}
                          </div>
                          ...
                          <div className="flex items-center gap-1.5 pt-3 mt-3 border-t border-slate-800/80">
                            <button
                              onClick={() =>
                                setActiveStatutoryModal(slot.templateType)
                              }
                              className={`flex-1 py-1.5 rounded-lg text-xs font-bold transition flex items-center justify-center gap-1.5 cursor-pointer shadow ${
                                isCompleted
                                  ...
                                  : "bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-blue-600/20"
                              }`}
                            >
                  ...
                  <div className="pt-6 border-t border-slate-800 space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div>
                        ...
                        <p className="text-[11px] text-slate-400">
                          Upload supplemental bid bulletins, pre-bid minutes,
                          site inspection logs, and custom technical notes.
                        </p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                      {otherDocs.length === 0 ? (
                        <div className="col-span-2 p-6 text-center bg-slate-950/40 rounded-xl border border-dashed border-slate-800 text-slate-500 text-xs">
                          No supplemental files attached. Click "+ Add
                          Supplementary File" to attach additional documents.
                        </div>
                      ) : (
                        otherDocs.map((doc) => (
                          <div
                            key={doc.slotKey}
                            className="p-3.5 bg-slate-950/70 border border-slate-800 rounded-xl flex items-center justify-between"
                          >
                            ...
                            <div className="flex items-center gap-1 shrink-0">
                              <button
                                onClick={async () => {
                                  ...
                                  if (!dataUrl) {
                                    dataUrl = await loadPdfData(
                                      `proj_other_${tenantId}_${projectScopeKey}_${doc.slotKey}`,
                                    );
                                  }
                                  if (dataUrl) {
                                    setPreviewPdfModal({
                              ...
                              <button
                                onClick={() => {
                                  if (confirm(`Delete ${doc.slotTitle}?`)) {
                                    const updated = otherDocs.filter(
                                      (d) => d.slotKey !== doc.slotKey,
                                    );
                                    setOtherDocs(updated);
                                    localStorage.setItem(
                                      `bidocs_other_docs_${tenantId}_${projectScopeKey}`,
            ...
            <div className="p-10 sm:p-12 text-center bg-slate-900/60 border border-slate-800/90 rounded-2xl space-y-4 shadow-2xl backdrop-blur-md relative overflow-hidden">
              ...
              <div className="space-y-1.5 max-w-lg mx-auto">
                <h3 className="text-lg font-black text-white">
                  No Merged Bidding Projects Found
                </h3>
                <p className="text-xs text-slate-400 leading-relaxed">
                  In accordance with your bidding governance workflow, projects
                  will only be visible in <strong>Project Status</strong> after
                  their Bidding Documents package (Original, Copy 1, and Copy 2)
                  has been compiled, merged, and completed in the{" "}
                  <strong>Bid Package Builder</strong>.
                </p>
              </div>
              <div className="flex items-center justify-center gap-3 pt-2 flex-wrap">
                <button
                  onClick={() => setActiveTab("bids")}
                  className="px-4 py-2 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white rounded-xl text-xs font-bold flex items-center gap-2 transition shadow-lg shadow-blue-600/30 border border-blue-400/40 cursor-pointer"
                >
          ...
          <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl p-6 space-y-4 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">
                    Record expenditure details and attach official receipt or
                    invoice proof.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-emerald-400 mb-1 font-mono font-bold">
                    AMOUNT (PHP) *
                  </label>
                  <input
                    type="text"
                ...
                {expenseFormReceiptName ? (
                    ...
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[10px] text-slate-400 font-mono">
                          {expenseFormReceiptSize
                            ? formatBytes(expenseFormReceiptSize)
                            : "File Attached"}{" "}
                          •{" "}
                          {expenseFormReceiptType?.includes("pdf")
                            ? "PDF Document"
                  ...
                  <label className="border-2 border-dashed border-slate-700 hover:border-cyan-500/70 bg-slate-900/50 hover:bg-slate-900 rounded-xl p-4 flex flex-col items-center justify-center gap-1.5 text-center cursor-pointer transition">
                    ...
                    <span className="text-[10px] text-slate-400">
                      Official Receipt (OR), Bank Deposit Slip, Cash Voucher, or
            ...
            <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-800">
              ...
              <button
                ...
                className="px-5 py-2 bg-linear-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white rounded-xl text-xs font-bold shadow-lg shadow-cyan-600/30 flex items-center gap-1.5 cursor-pointer"
              >
          ...
          <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-3xl overflow-hidden shadow-2xl space-y-4 p-6 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Enter bidding parameters, ABC details, and BAC Procuring
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  >
                    ...
                    <option value="CONSULTING_SERVICES">
                      Consulting Services
                    </option>
                  </select>
                </div>
              ...
              <div className="p-3.5 bg-slate-950 rounded-xl border border-slate-800 space-y-2">
                <label className="block text-emerald-400 font-mono font-bold">
                ...
                <p className="text-[11px] font-serif italic text-slate-400">
                  Amount in words:{" "}
                  {numberToWords(formAbc || parsePhpCurrency(formAbcInput))}
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormEntityContactPerson(e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormEntityContactNumber(e.target.value)
                      }
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div>
                  <label className="block text-red-400 font-mono mb-1 font-bold">
                    SUBMISSION DEADLINE *
                  </label>
                  <input
                    type="datetime-local"
            ...
            <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-800">
              ...
              <button
                ...
                className="px-5 py-2 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white rounded-xl text-xs font-bold shadow-lg shadow-blue-600/30 flex items-center gap-1.5 cursor-pointer"
              >
                <CheckCircle2 className="w-4 h-4" />
